...
dataset = [
        ...
        # AIMessage(content="Since I can't directly make calls for you, here's how you can use your phone to invite your other friends to your birthday party:\n\n1. Prepare what to say:\n\nStart with a friendly greeting and mention it's your birthday coming up on April 21st.\nBriefly describe your party (type, date, time) and some highlights (food, games, etc.)\nExpress your desire for them to attend and ask if they can make it.\nSet an RSVP date.\nEnd with enthusiasm about celebrating with them.\n\n2. Initiate the call:\n\nOpen the phone app on your device.\nFind your friend's phone number in your contacts or call history.\nTap the number to initiate the call.\n3. Sample Script (Adapt as needed):\n'Hey [Friend's name], how is it going? Guess what! My birthday is coming up on April 21st and I'm having a [party type] at my place at [time]. There will be [mention highlights]. It would be awesome if you could make it!  Let me know by [RSVP date] if you can swing by.  Really looking forward to celebrating with you!'\n4. Additional Tips:\nBe mindful of the time you're calling. Avoid calling too early in the morning or too late at night.\nIf you don't get a hold of them, consider leaving a voicemail briefly mentioning the same details and your request for an RSVP.\nTexting can also be an option for some friends, following a similar format to the script above."),
